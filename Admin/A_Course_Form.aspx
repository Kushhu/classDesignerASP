<%@ Page Title="Course Form" Language="C#" MasterPageFile="~/Admin/Admin_Master.master" AutoEventWireup="true" CodeFile="A_Course_Form.aspx.cs" Inherits="Admin_A_CourseForm" %>
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Add New Course</h5>
                        </div>

                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#">Add Course</a></li>
                            <li class="breadcrumb-item float-right"><a href="A_Course_List.aspx"><i class="feather icon-skip-back mr-2"></i>Go to Course List</a></li>
                        </ul>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label class="floating-label" for="txt_course_name">Enter Course Name</label>
                            <asp:TextBox ID="txt_course_name" runat="server" CssClass="form-control"></asp:TextBox>
                            <asp:RequiredFieldValidator SetFocusOnError="true" runat="server" ID="rf_txt_course_name" Display="Dynamic" ControlToValidate="txt_course_name" CssClass="mt-2" ErrorMessage="! Please Fill Course Name" ValidationGroup="save" Font-Bold="true" ForeColor="Red"></asp:RequiredFieldValidator>
                        </div>
                        <div class="form-group">
                            <b class="d-block">
