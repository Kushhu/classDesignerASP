<%@ Page Title="Add New Fees" Language="C#" MasterPageFile="~/Admin/Admin_Master.master" AutoEventWireup="true" CodeFile="A_Fees_Form.aspx.cs" Inherits="Admin_A_Fees_Form" %>
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Add New Fees</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Add Fees</a></li>
                            <li class="breadcrumb-item float-right"><a href="A_Fees_List.aspx"><i class="feather icon-skip-back mr-2"></i>Go to Fees List</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <asp:UpdatePanel runat="server" ID="up_pnl_course_dr">
                            <ContentTemplate>
                                ...
                                <div class="form-group">
                                    <asp:DropDownList runat="server" ID="dr_sub_course_name" CssClass="js-example-data-array form-control">
                                    </asp:DropDownList>
                            ...
                            <Triggers>
                                <asp:PostBackTrigger ControlID="dr_course_name" />
                                <asp:PostBackTrigger ControlID="dr_sub_course_name" />
                            </Triggers>
                        </asp:UpdatePanel>
                        <div class="form-group">
                            <label class="floating-label" for="txt_sub_course_name">Enter Fess Amount</label>
                            <asp:TextBox ID="txt_fees_amount" runat="server" CssClass="form-control"></asp:TextBox>
                            <asp:RequiredFieldValidator SetFocusOnError="true"  runat="server" ID="rf_txt_fees_amount" Display="Dynamic" ControlToValidate="txt_fees_amount" CssClass="mt-2" ErrorMessage="! Please Fill Fees Amount" ValidationGroup="save" Font-Bold="true" ForeColor="Red"></asp:RequiredFieldValidator>
                            <br />
                            <asp:RegularExpressionValidator SetFocusOnError="true"  runat="server" ID="rex_txt_fees_amount" Display="Dynamic" ControlToValidate="txt_fees_amount" CssClass="mt-2" ErrorMessage="! Please Fill Fees Amount in Correct Format" ValidationExpression="^\d{0,8}(\.\d{1,4})?$" ValidationGroup="save" Font-Bold="true" ForeColor="Red"></asp:RegularExpressionValidator>
                        </div>
                        <div class="form-group">
                            <b class="d-block">
