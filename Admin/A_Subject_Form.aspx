<%@ Page Title="Add New Subject" Language="C#" EnableEventValidation="true" MasterPageFile="~/Admin/Admin_Master.master" AutoEventWireup="true" CodeFile="A_Subject_Form.aspx.cs" Inherits="Admin_A_Subject_Form" %>
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Add New Subject </h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#">Add Subject</a></li>
                            <li class="breadcrumb-item float-right"><a href="A_Subject_List.aspx"><i class="feather icon-skip-back mr-2"></i>Go to Subject List</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-12 col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label class="floating-label" for="txt_subject_name">Enter Subject Name</label>
                            <asp:TextBox ID="txt_subject_name" runat="server" CssClass="form-control"></asp:TextBox>
                            <asp:RequiredFieldValidator SetFocusOnError="true"  runat="server" ID="rf_txt_subject_name" Display="Dynamic" ControlToValidate="txt_subject_name" CssClass="mt-2" ErrorMessage="! Please Fill Subject Name" ValidationGroup="save" Font-Bold="true" ForeColor="Red"></asp:RequiredFieldValidator>
                        </div>
                        <div class="form-group">
                            <b class="d-block">
